...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://mononen.dev/}{\Large Alex Mononen}} & Email : \href{mailto:alex@mononen.dev}{alex@mononen.dev}\\
  \href{http://mononen.dev/}{http://www.mononen.dev} & Mobile : +1-916-234-6087 \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in Computer Science;  GPA: 3.66}{Aug. 2018 -- July. 2022}
